    ...
    return (
        <div>
            ...
            <div className='MovieWrapper'>
                <div className='filterSection'>
                    ...
                    <div className='genreFilter'>
                        <div className='actualFilter'>
                            <button onClick={handleDropdown}>Genre
                            </button>
                            ...
                            <ul>
                                {
                                    genreList.map((ele, index) => {
                                        return (
                                            <li key={index} >
                                                <input type='checkbox' onChange={() => handleGenreChange(index)} checked={ele.toggle}/>  {ele.name}
                                            </li>
                                        )
                                    })
                                }
                ...
                {movieList.length>1 ?<div className='listSection'>
